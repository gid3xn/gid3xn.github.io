<html>
    ...
    <body>
        ...
        <p>GJE</p>
        <p>
            <p> Right now, you have a supercomputer aimed at your head. As you read these words, billions of dollars of digital machinery fights for your most precious resource—your attention. Thankfully, you’re a human. You’re smarter than the even the smartest artificial intelligence that, even now, builds a dossier on you with every click, every keystroke. For now. How will you resist the prod-ding of an algorithm that is smarter than you, knows about you about you than you do, and has instantaneous access to all the worlds’ information? </p>
